<template>
  <div class="publicBidding-list" @click="goLand()">
    <a class="publicBidding-list-item">
      <div class="publicBidding-list-logo">
        <i class="fa fa-pencil-square-o fa-2x reception-icon"></i>
      </div>
      <div class="publicBidding-list-header overflow-hidden">{{title}}</div>
      <div class="publicBidding-list-content">
        <div>
          <div class="list-item">
          ...
          <div class="publicBidding-list-select">
