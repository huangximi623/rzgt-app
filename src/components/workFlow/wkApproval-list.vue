<template>
  <div class="wkApproval-list" @click="goLand()">
    <a class="wkApproval-list-item">
      <div class="wkApproval-list-logo">
        <i class="fa fa-pencil-square-o fa-2x reception-icon"></i>
      </div>
      <div class="wkApproval-list-header overflow-hidden">{{title}}</div>
      <div class="wkApproval-list-content">
        <div>
          <div class="list-item">
          ...
          <div class="wkApproval-list-select">
