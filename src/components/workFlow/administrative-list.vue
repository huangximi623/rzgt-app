<template>
  <div class="administrative-list" @click="goLand()">
    <a class="administrative-list-item">
      <div class="administrative-list-logo">
        <i class="fa fa-pencil-square-o fa-2x reception-icon"></i>
      </div>
      <div class="administrative-list-header overflow-hidden">{{title}}</div>
      <div class="administrative-list-content">
        <div>
          <div class="list-item">
          ...
          <div class="administrative-list-select">
