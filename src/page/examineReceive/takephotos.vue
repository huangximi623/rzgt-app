    ...
    export default {
      ...
      methods: {
        ...
        init() {
          ...
          document.getElementById('myImage').src=document.getElementById('myImage').src+"?"+Math.random();
        },
        goBack() {
          this.wgt="";
          this.photovalue=[];
        ...
        takefromgalery() {
          ...
          function onFail(message) {
           ...
           /* var fileURL = "///storage/emulated/0/DCIM/Camera/VID_20181101_184537.mp4"//模拟本地的文件*/
            var uri = encodeURI("http://10.1.196.65:8088/UpLoadPicture.aspx");
             //var uri = encodeURI("http://10.5.97.145:59864/UpLoadPicture.aspx");
