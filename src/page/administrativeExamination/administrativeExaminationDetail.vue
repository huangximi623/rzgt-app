<template>
  <div class="administrativeExaminationDetail">
...
<script>
  ...
  export default {
    ...
    methods: {
      goBack() {
        this.$router.push({path: '/administrativeExamination', query: {page: 'administrativeExaminationDetail'}})
      },
      init() {
...
<style lang="scss">
  ...
  .administrativeExaminationDetail {
    background: #fff;
    .body-content {
      display: block;
      overflow: auto;
