<template>
  <div class="administrativeExamination">
      ...
      <mt-loadmore v-else class="list-selector" :top-method="loadTop" :bottom-method="loadBottom"
        ...
        <mt-tab-container v-model="selected">
          <mt-tab-container-item id="1">
            <div id="todo">
              <administrative-list v-for='(item,index) in dealtInfo'
                                   :key="index"
...
<script>
  ...
  import AdministrativeList from '@/components/workFlow/administrative-list.vue'
  ...
  export default {
    ...
    components: {HeaderSimple, BodyContent, AdministrativeList},
    methods: {
      goBack() {
