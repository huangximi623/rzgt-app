<template>
  <div class="jhApprovalDetail">
    ...
    <body-content class="body-content"
      ...
      <!--附件区-->
      <attachments-area :attachmentsInfo="administrativeInfo" :detailsPage="'京华审批'"></attachments-area>
    </body-content>
...
<script>
  ...
  export default {
    ...
    methods: {
      goBack() {
        this.$router.push({path: '/jhApproval', query: {page: 'jhApprovalDetail'}})
      },
      init() {
      ...
      getProcessAndDetails(type, params) {
        ...
        //同时执行多个请求
        axios.all([
          interfaceService.queryJhApprovalProcess(params),
          interfaceService.queryJhApprovalDetails(type, params)
        ])
