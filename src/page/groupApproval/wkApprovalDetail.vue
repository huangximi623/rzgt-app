<template>
  <div class="wkApprovalDetail">
    ...
    <body-content class="body-content"
      ...
      <!--附件区-->
      <attachments-area :attachmentsInfo="administrativeInfo" :detailsPage="'营钢审批'"></attachments-area>
    </body-content>
...
<script>
  ...
  export default {
    ...
    methods: {
      goBack() {
        this.$router.push({path: '/wkApproval', query: {page: 'wkApprovalDetail'}})
      },
      init() {
      ...
      getProcessAndDetails(type, params) {
        ...
        //同时执行多个请求
        axios.all([
          interfaceService.queryWkApprovalProcess(params),
          interfaceService.queryWkApprovalDetails(type, params)
        ])
